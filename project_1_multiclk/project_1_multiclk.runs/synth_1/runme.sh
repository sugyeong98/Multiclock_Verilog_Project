...
HD_PWD='C:/Users/SUJIN/Desktop/sg_workspace/vivado_2019/project_1_multiclk/project_1_multiclk.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log project_top_module_multiclk_240726.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source project_top_module_multiclk_240726.tcl
